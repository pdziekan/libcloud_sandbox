...
VERBOSE=1 mpic++ -DSTD_FUTURE_WORKS -std=c++11  -fopenmp -pthread -g -I/people/plgpdziekan/code/libcloudphxx/include -I/software/local/el6/COMMON/libs/boost/1.59.0/include -L/people/plgpdziekan/code/libcloudphxx/build/src/  libcloud_mpi_test.cpp -lcloudphxx_lgrngn
